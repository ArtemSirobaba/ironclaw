...
export function McpTab({ mcpServers, mcpRegistry, onActivate, onConfigure, onRemove, onInstall, isBusy }) {
    ...
    return html`
      <div className="v2-panel rounded-[18px] p-6 sm:p-8">
        ...
        <p className="mt-2 max-w-md text-sm leading-6 text-iron-300">
          MCP servers extend the agent with additional tool capabilities over the Model Context Protocol.
          Install them from the registry.
        </p>
      </div>
    `;
  }
